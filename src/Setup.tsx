	...
	return (
		<View style={{ flex: 1 }}>
			...
			<Text style={{ textAlign: 'center' }}>
				Please connect to the PC host software to start scanning.
			</Text>
			<Text style={{ textAlign: 'center' }}>You can download it from:</Text>
			<Text style={{ textAlign: 'center' }}>
				https://github.com/gergof/barcode-to-pc
			</Text>
			...
			<TextInput
				...
				placeholder="http://192.168.0.100:4747"
			/>
			<Button onPress={onSubmit} title="Submit" />
			<View style={{ height: 50 }} />
			<Text style={{ marginBottom: 8 }}>
				Or scan QR code shown in terminal:
			</Text>
			<View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
				<View
					style={{
